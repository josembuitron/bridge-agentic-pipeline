...
| **hyperframes** | HTML+GSAP-to-image-or-video renderer for branded visuals, hero slides, infographics, data viz stills, optional MP4 explainers | Phase 3 (diagram fallback), Phase 5 (MANDATORY for PPTX visuals) | `modules/hyperframes-renderer.md` |
