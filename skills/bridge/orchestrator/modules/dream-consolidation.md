...
- "Hyperframes hero slides generated in 5/7 projects"
...
| Hyperframes | 90% | First-render Chrome download (~150MB) | USE — pre-warm cache once per machine |
...
- PPTX: pptxgenjs + Hyperframes hero slides (high quality)
